<script>
  ...
  import { alertSuccess, alertConfirm, alertError } from "$lib/alert";
  ...
  async function handleDeleteContact(id) {
    if (!(await alertConfirm("Are you sure you want ro delete this contact"))) {
      return;
    }
...
<div class="container mx-auto px-4 py-8 flex-grow">
  <div class="flex items-center mb-6">
    <i class="fas fa-users text-blue-400 text-2xl mr-3" />
  ...
  >
    <div class="flex items-center justify-between mb-4">
      <div class="flex items-center">
        <i class="fas fa-search text-blue-400 mr-3" />
      ...
      >
        <i class="fas fa-chevron-down text-lg" id="toggleSearchIcon" />
      </button>
    </div>
    <div id="searchFormContent" class="mt-4">
      <form onsubmit={handleSearch}>
        ...
        <div class="mt-5 text-right">
          ...
          >
            <i class="fas fa-search mr-2" /> Search
          </button>
        </div>
      </form>
    </div>
    ...
    >
      <a href="/dashboard/contacts/create" class="block p-6 h-full">
        ...
        >
          ...
          >
            <i class="fas fa-user-plus text-3xl text-white" />
          </div>
          ...
          >
            ...
            <div class="space-y-3 text-gray-300 ml-2">
              <p class="flex items-center">
                <i class="fas fa-user-tag text-gray-500 w-6" />
              ...
              <p class="flex items-center">
                <i class="fas fa-envelope text-gray-500 w-6" />
                <span class="font-medium w-24">Email:</span>
                <span>{contact.email}</span>
              </p>
              <p class="flex items-center">
                <i class="fas fa-phone text-gray-500 w-6" />
  ...
  <div class="mt-10 flex justify-center">
    ...
    >
      {#if search.page > 1}
        ...
        >
          <i class="fas fa-chevron-left mr-2" /> Previous
        </a>
      {/if}
